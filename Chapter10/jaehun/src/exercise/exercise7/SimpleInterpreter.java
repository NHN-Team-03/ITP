...
public class SimpleInterpreter {
    ...
    private static void doLetCommand() throws ParseError {
        ...
        TextIO.getChar();
        Object val = expressionValue(); // The value of the variable.
        TextIO.skipBlanks();
        if (TextIO.peek() != '\n')
    ...
    private static double primaryValue() throws ParseError {
        ...
        if (Character.isDigit(ch)) {
            ...
            if (val instanceof StandardFunction) {
                TextIO.getAnyChar();
                double number = primaryValue();
                TextIO.getAnyChar();

                return ((StandardFunction) val).evaluate(number);
            }
            if (val == null)
    ...
    private static String readWord() {
        ...
        while (Character.isLetter(ch) || Character.isDigit(ch)) {
            word.append(TextIO.getChar()); // Add the character to the word.
            ch = TextIO.peek();
        }
