...
* 3-3. 연습문제인 경우 src폴더 하위에 `Exercise` 폴더를 생성합니다.
* 3-4. 연습문제 번호에 맞게 `Exercise-number.java` 파일 이름을 정합니다.
* 3-5. `*Chapter1/seungjo/src/Exercise/Exercise1.java*` 와 같은 경로가 되도록 합니다.
