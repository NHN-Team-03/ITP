...
public class SimpleParser3 {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            try {
                ...
                TextIO.getln();
                System.out.println("\nValue is " + exp.value(0) + "when x = 0");
                System.out.println("Value is " + exp.value(1) + "when x = 1");
                System.out.println("Value is " + exp.value(2) + "when x = 2");
    ...
    private static ExpNode factorTree() throws ParseError {
        ...
        if (Character.isDigit(ch)) {
            ...
            char variable = TextIO.getAnyChar();
